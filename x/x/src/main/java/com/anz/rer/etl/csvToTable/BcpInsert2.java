...
public class BcpInsert2 implements Runnable{
   
	private final static Logger logger = Logger.getLogger(BcpInsert2.class);
	...
	public BcpInsert2(BlockingQueue<BcpData> sqlQueue,
