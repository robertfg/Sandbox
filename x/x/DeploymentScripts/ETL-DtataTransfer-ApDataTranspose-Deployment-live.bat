...
::Deployment of ETL-DtataTransfer - ApDataTranspose-Live

::ETL service names
set serviceName1=ApDataTranspose
...
set tomcatLocation1=F:\ETL\ApDataTranspose\prelive

::Get date as yyyymmdd_hhmm 
set date=%date:~-4%%date:~7,2%%date:~4,2%_%time:~0,2%%time:~3,2%

echo ********************ApDataTranspose-Live Deployment********************
...
echo ETL-DtataTransfer - ApDataTranspose-live
pause
