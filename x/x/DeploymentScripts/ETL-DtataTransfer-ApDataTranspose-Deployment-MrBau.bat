...
::Deployment of ETL-DtataTransfer - ApDataTranspose-MR_BAU

::ETL service names
set serviceName1=MR_BAU-ApDataTranspose
...
set tomcatLocation1=D:\ETL\mr_bau\ApDataTranspose

::Get date as yyyymmdd_hhmm 
::set date=%date:~-4%%date:~7,2%%date:~4,2%_%time:~0,2%%time:~3,2%

echo ********************ApDataTranspose-MR_BAU Deployment********************
...
echo ETL-DtataTransfer - ApDataTranspose-MR_BAU
pause
