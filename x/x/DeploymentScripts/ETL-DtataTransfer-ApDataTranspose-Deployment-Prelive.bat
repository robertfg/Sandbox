...
::ETL service names
set serviceName1=MR_PRELIVE-ApDataTranspose
...
set tomcatLocation1=D:\ETL\mr_prelive\ApDataTranspose

::Get date as yyyymmdd_hhmm 
::set date=%date:~-4%%date:~7,2%%date:~4,2%_%time:~0,2%%time:~3,2%

echo ********************ApDataTranspose-PreLive Deployment********************
...
echo ETL-DtataTransfer - ApDataTranspose-Prelive
pause
