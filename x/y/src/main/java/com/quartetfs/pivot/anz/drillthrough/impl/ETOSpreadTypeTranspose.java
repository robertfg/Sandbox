...
public class ETOSpreadTypeTranspose 
{
	...
	public ETOSpreadTypeTranspose(TransposeRequestInput transposeDTO) {
		super();
	...
	private void aggregateRows(TransposeRequestInput transposeDTO,Map<Point, DrillThroughRowContent> capFloorData) {
		...
		{	
			...
			if(!transposeDTO.isAllowedTerm(termValue.toString()) ||  !transposeDTO.isAllowedUnderlyingTerm(scenarioTermValue))
			{
				continue;
			}		
