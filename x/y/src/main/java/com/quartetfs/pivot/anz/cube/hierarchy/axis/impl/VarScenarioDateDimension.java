 ...
 */
@QuartetExtendedPluginValue(interfaceName = "com.quartetfs.biz.pivot.cube.hierarchy.IDimension", key = VarScenarioDateDimension.PLUGIN_KEY)
public class VarScenarioDateDimension extends AAnalysisDimension{

	private IDateService dateService;
	private  String varDateType;
	
	public VarScenarioDateDimension(final String name, final int ordinal,
			final Properties properties, final Set<String> measureGroups) {
		super(name, ordinal, properties, measureGroups);
		
		varDateType=(String)properties.get(ANZConstants.VAR_DATE_TYPE);
	...
	public static final String PLUGIN_KEY = "VAR_SCENARIO_DATE";
	@Override
	...
	public Collection<Object[]> buildDiscriminatorPaths() {
		...
		for (IDate date:dateService.getHistoryDates( varDateType )){
