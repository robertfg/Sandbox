 ...
 */
@QuartetExtendedPluginValue(interfaceName = "com.quartetfs.biz.pivot.cube.hierarchy.IDimension", key = VarScenarioNumberDimension.PLUGIN_KEY)
public class VarScenarioNumberDimension extends AAnalysisDimension {
	private static final long serialVersionUID = -4420428241556492961L;

	public static final String PLUGIN_KEY = "VAR_SCENARIO_DIM";

	
	private PSRDetail psrDetail;
	private Set<String> psrNames=null;
	
	public VarScenarioNumberDimension(final String name, final int ordinal,
	...
	public Collection<Object[]> buildDiscriminatorPaths() {
		...
		Long index =1L;
		while(index<=ANZConstants.VECTOR_LENGTH) {
