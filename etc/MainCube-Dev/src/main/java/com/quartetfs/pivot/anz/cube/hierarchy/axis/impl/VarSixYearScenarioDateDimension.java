 ...
 */
@QuartetExtendedPluginValue(interfaceName = "com.quartetfs.biz.pivot.cube.hierarchy.IDimension", key = VarSixYearScenarioDateDimension.PLUGIN_KEY)
public class VarSixYearScenarioDateDimension extends AAnalysisDimension{

	private IDateService dateService;
	private static final String TYPE = "VARSIXYEARDATES";
	
	public VarSixYearScenarioDateDimension(final String name, final int ordinal,
	...
	public static final String PLUGIN_KEY = "VAR_SIX_YEAR_SCENARIO_DATE";
	...
	public Collection<Object[]> buildDiscriminatorPaths() {
		...
		if(dateService.getHistoryDates( TYPE )!=null){
