...
public class RebuildCubeFromJmx {
	...
	public RebuildCubeFromJmx(){}
	
	public RebuildCubeFromJmx(String userName, String password, String hostAddr, String port) {
		super();
	...
	public boolean invoke(String jmxBeanName, String jmxMethodName) throws IllegalStateException { 
			...
			MBeanOperationInfo[] operationInfo = mbsc.getMBeanInfo(instance.getObjectName()).getOperations();
				...
				if( checkIfCommandIsValidInBean(operationInfo, jmxMethodName) ) {
					Object result = mbsc.invoke(instance.getObjectName(), jmxMethodName, null, null);
					retValue = true;
