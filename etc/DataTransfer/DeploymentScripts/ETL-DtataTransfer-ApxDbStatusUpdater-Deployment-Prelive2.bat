...
::Deployment of ETL-DtataTransfer - ApxDbStatusUpdater-prelive2

::ETL service names
set serviceName1=MR_PRELIVE2-ApxDbStatusUpdater

::ETL app name - make sure it is the correct version 
set etlAppName=mx

:: tomcat server locations
set tomcatLocation1=D:\ETL\mr_prelive2\ApxDbStatusUpdater


::Get date as yyyymmdd_hhmm 
::set date=%date:~-4%%date:~7,2%%date:~4,2%_%time:~0,2%%time:~3,2%

echo ********************ApxDbStatusUpdater-prelive2********************
...
echo ETL-DtataTransfer - ApxDbStatusUpdater-Prelive2
pause
