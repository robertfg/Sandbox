...
::Deployment of ETL-DtataTransfer - ApToDB-Prelive2

::ETL service names
set serviceName1=MR_PRELIVE2-ApDataExtractToDB
...
echo ETL-DtataTransfer - ApToDB-Prelive2
pause
