...
::Deployment of ETL-DtataTransfer - MurexToDB-Prelive2

::ETL service names
set serviceName1=MR_PRELIVE2-MurexFeedToDB
...
set tomcatLocation1=D:\ETL\mr_prelive2\MurexFeedToDB


::Get date as yyyymmdd_hhmm 
set date=%date:~-4%%date:~7,2%%date:~4,2%_%time:~0,2%%time:~3,2%

echo ********************MurexFeedToDB-ETP Prelive2 Deployment********************
...
echo ETL-DtataTransfer - MurexFeedToDB-Prelive2
pause
