...
::Deployment of ETL-DtataTransfer - MurexToDB-Prelive

::ETL service names
set serviceName1=MR_PRELIVE-MurexFeedToDB
...
set tomcatLocation1=D:\ETL\mr_prelive\MurexFeedToDB


::Get date as yyyymmdd_hhmm 
set date=%date:~-4%%date:~7,2%%date:~4,2%_%time:~0,2%%time:~3,2%

echo ********************MurexFeedToDB-ETP Prelive Deployment********************
...
echo ETL-DtataTransfer - MurexFeedToDB-Prelive
pause
