...
::Deployment of ETL-DtataTransfer - ApDataTranspose-PreLive

::ETL service names
set serviceName1=MR_PRELIVE2-ApDataTranspose

::App name - app will be deployed with this name
set warName=mx

set appName=ApDataTranspose

:: tomcat server locations
set tomcatLocation1=D:\ETL\mr_prelive2\ApDataTranspose

::Get date as yyyymmdd_hhmm 
::set date=%date:~-4%%date:~7,2%%date:~4,2%_%time:~0,2%%time:~3,2%

echo ********************ApDataTranspose-PreLive2 Deployment********************
...
echo ETL-DtataTransfer - ApDataTranspose-Prelive2
pause
