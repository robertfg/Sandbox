...
public class Test2 {
	...
	public static void main(String[] args) {
		...
		for (String line: lines) {
			...
			String key = newTransaction[ACCOUNT] + "|" + newTransaction[SECURITY_ID] + "|" + newTransaction[TRADE_ID];
		
			String currentPositionKey = newTransaction[ACCOUNT] + "|" + newTransaction[SECURITY_ID];
