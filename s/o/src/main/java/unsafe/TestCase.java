...
public class TestCase {
    ...
    public static void main(String... args) {
        ...
        if (args == null || args.length == 0) {
            args = new String[]{Allocator.Type.OFFHEAP.name(), "1000"};
        }
        ...
        final OffHeap[] types = new OffHeap[]{new Index(1000)};
    ...
    public static void testIndex(){
    	...
    	OffHeap index = new Index(1000);
    	        index.navigate(0);
    	        index.setInt(2000);
    	        index.setLong(100);

    	OffHeap lookUp = new Index(1000);
    	lookUp.navigate(0);
    	lookUp.setInt(1000);
    	lookUp.setLong(120576);
    	
    	index.navigate(0);
    	System.out.println( index.getInt() );
    	
    	lookUp.navigate(0);
    	 
    	System.out.println( lookUp.getInt() );
    	lookUp.contains(0);
    ...
    public static int write(OffHeap t, int items) {
        int index = 0;
    ...
    public static int read(OffHeap t, int items) {
        int sum = 0;
    ...
    public static int randomRead(OffHeap t, int items, final int[] idx) {
        int sum = 0;
