...
public class FredAlgo {
	...
	public void push(int row, int column, int value, String origin){
		...
		String s = origin + String.format("/[row:%s,value:%s-{column:%s,columnValue1:%s,"
				+ "firstValue:%s},{nextColumn:%s,columnValue2:%s,secondValue:%s}]", row, value,
...
//93+16+58+78+91+32+83+6+7+75+47+10+82+64+75
		...
		FredAlgo triExam = new FredAlgo(simple);
		triExam.process();
