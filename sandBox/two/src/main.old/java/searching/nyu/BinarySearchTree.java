...
{  
    ...
    {
        return (Comparable) (t == null ? null : t.element);
    }
...
/* 9*/      return t;
     ...
     * @return the new root.
     */
    private BinaryNode remove( Object element, BinaryNode t )
    {
        if( t == null )
            return t;   // Item not found; do nothing
        if( ((Comparable) element).compareTo( t.element ) < 0 ) 
            t.left = remove( element, t.left );
        else if( ((Comparable) element).compareTo( t.element ) > 0 )
